...
$db = 
  [
    'first_faq' => [
        'question' => "<h1>How are you implementing the recent Court of Justice of the European Union (CJEU) decision on the right to be forgotten?</h1>",
    ...
    'second_faq' => [
      'question' => '<h1>How does Google protect my privacy and keep my information secure?</h1>',
    ...
    'third' => [
      'question' => '<h1>Why is my account associated with a country?</h1>',
  ...
  If the country associated with your account doesn’t correspond to your country of residence, it could be because of a difference between your country of work and residence, because you’ve installed a Virtual Private Network (VPN) to mask your IP address, or because you live close to a territorial border. Contact us if you think your country association is wrong.</p>'
    ],
    'fourth' => [
      'question' => "<h1>How can I remove information about myself from Google's search results?</h1>",
    ...
    'fifth' => [
      'question' => "<h1>Are my search queries sent to websites when I click on Google Search results?</h1>",
